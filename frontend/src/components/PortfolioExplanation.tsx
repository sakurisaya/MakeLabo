                ...
                <div className="space-y-4">
                    <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)] hover:shadow-lg transition-all duration-300">
                        ...
                        <p className="text-slate-500 leading-relaxed text-[13px] pl-4">
                            記録を続けるうちに、自分に似合う色の組み合わせや、肌コンディション別のテクニックが自然と見えてきます。<br />なんとなくうまくいった日も、ちゃんと再現できるように。
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)] hover:shadow-lg transition-all duration-300">
                        ...
                        <p className="text-slate-500 leading-relaxed text-[13px] pl-4">
                            「なんかピンクっぽい」で終わらせない。MakeLaboはPCCS体系をベースにした、感覚的にわかりやすい色の言葉で表示されます。<br />使い続けるうちに、自然と色のトーンや特性に詳しくなれます。
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)] hover:shadow-lg transition-all duration-300">
                        ...
                        <p className="text-slate-500 leading-relaxed text-[13px] pl-4">
                            使ったコスメの色をカラーチップとしてまとめて表示。<br />「なんかまとまりがあったな」「今日はコントラストが強かったな」が、<br />感覚じゃなくて色として確認できます。
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)] hover:shadow-lg transition-all duration-300">
                        ...
                        <p className="text-slate-500 leading-relaxed text-[13px] pl-4">
                            服もアクセサリーもピン留めOK。<br />その日のトータルコーデをまるごと残せるので、「あのワンピースに合わせたメイク」も迷わず引き出せます。
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)] hover:shadow-lg transition-all duration-300">
                        ...
                        <p className="text-slate-500 leading-relaxed text-[13px] pl-4">
                            増え続けるコスメ、把握できていますか？<br />ブランド・カテゴリ別に整理できるので、<br />「これ持ってたっけ？」「また同じ色買ってた」がなくなります。
                        </p>
                    </div>
