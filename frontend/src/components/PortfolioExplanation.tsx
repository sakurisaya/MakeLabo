                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-6 rounded-3xl border border-slate-100 bg-white hover:shadow-lg transition-all duration-300">
                        ...
                        <p className="text-xs text-slate-500 leading-relaxed mb-3">
                            ...
                            AWS EC2単一インスタンスと外部DB（Supabase）を組み合わせた、低コストかつセキュアなRESTful API。PCCS色彩理論を用いた色相・トーンの自動判定アルゴリズムを実装。
                        </p>
                        <div className="flex flex-wrap gap-1">
                ...
                <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100/50">
                    <ul className="space-y-4 text-sm text-slate-600">
                        ...
                        <li className="flex items-start gap-3">
                            <div className="w-1.5 h-1.5 bg-pink-400 rounded-full mt-1.5 flex-shrink-0" />
                            <div>
                                <strong className="text-slate-800 block mb-0.5">Elastic Beanstalk (EC2 Single Instance)</strong>
                                ロードバランサーを外し維持費を最小化した構成のPython APIサーバー。
                            </div>
                        </li>
                        <li className="flex items-start gap-3">
                            <div className="w-1.5 h-1.5 bg-pink-400 rounded-full mt-1.5 flex-shrink-0" />
                            <div>
                                <strong className="text-slate-800 block mb-0.5">Supabase (Database)</strong>
                                AWS外部のSaaS（PostgreSQL）にDBを切り出し、コストゼロで可用性とデータ永続化を両立。
                            </div>
                        </li>
                        <li className="flex items-start gap-3">
                            <div className="w-1.5 h-1.5 bg-pink-400 rounded-full mt-1.5 flex-shrink-0" />
